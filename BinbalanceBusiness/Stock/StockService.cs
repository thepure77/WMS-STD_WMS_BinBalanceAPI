...
namespace BinbalanceBusiness.BinBalanceService
{
    public class StockService
    {
        ...
        public StockService(BinbalanceDbContext db)
        {
            this.db = db;
        }


        public actionResultViewModel filterByProduct(StockBinbalanceViewModel model)
        {
            try
            {
                ...
                var query = db.wm_BinBalance.Where(c=> !location.Contains(c.Location_Index));
            ...
            //    });
                ...
                var join_sale = (from bin in queryGroup
                                 ...
                                 select new StockBinbalanceViewModel
                                 {
                ...
                var result = new List<StockBinbalanceViewModel>();
                int addNumber = 0;
                ...
                foreach (var item in Item)
                {
                    ...
                    var resultItem = new StockBinbalanceViewModel();
                    addNumber++;
        ...
        public actionResultViewModel filterByLocatuion(StockBinbalanceViewModel model)
        {
            try
            {
                var actionResult = new actionResultViewModel();
