...
{
    public partial class StockBinbalanceViewModel : Pagination
    {
        ...
        {
            public IList<StockBinbalanceViewModel> itemsStock { get; set; }
            public IList<StockBinbalanceViewModel> itemsStockLo { get; set; }
