...
namespace BinbalanceBusiness.Stock.ViewModels
{
    public partial class CheckStockMobileViewModel : Pagination
    {
        ...
        public decimal? SumQtyBal { get; set; }
        public decimal? SumQtyRe { get; set; }
        public decimal? SumWeight { get; set; }

        public class actionResultViewModel : Result
        {
            public IList<CheckStockMobileViewModel> itemsStock { get; set; }
            public IList<CheckStockMobileViewModel> itemsStockLo { get; set; }
            public Pagination pagination { get; set; }
        }
    }

    public class View_GroupProductViewModel
    {
        public Guid? Product_Index { get; set; }
        public string Product_Name { get; set; }
        public string Product_Id { get; set; }
