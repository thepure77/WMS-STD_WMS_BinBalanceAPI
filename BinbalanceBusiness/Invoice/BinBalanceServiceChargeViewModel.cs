...
{
    public partial class BinBalanceServiceChargeViewModel : Pagination
    {

        public BinBalanceServiceChargeViewModel()
        {
            listBinBalanceServiceCharge = new List<BinBalanceServiceChargeViewModel>();
        ...
        public string doc_DateTo { get; set; }
        ...
        public List<BinBalanceServiceChargeViewModel> listBinBalanceServiceCharge { get; set; }

    }

    public class actionResultBinBalanceServiceCharge
    {
        public IList<BinBalanceServiceChargeViewModel> items { get; set; }
        public Pagination pagination { get; set; }
    }
    //public class View_CalserviceCharge
    //{
