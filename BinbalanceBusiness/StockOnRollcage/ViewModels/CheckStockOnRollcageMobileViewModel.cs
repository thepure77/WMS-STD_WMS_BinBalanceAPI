...
{
    public partial class CheckStockOnRollcageMobileViewModel : Pagination
    {
        ...
        {
            public IList<CheckStockOnRollcageMobileViewModel> itemsStock { get; set; }
            public IList<CheckStockOnRollcageMobileViewModel> itemsStockLo { get; set; }
